# Doc Refresh Queue — November 2025

> Keep the canon scrolls in lockstep with Offline Continuity Mode while pivots stay live.

## Ground Rules

- Update highest-signal docs first (README hubs, pivot summaries, alfa map).
- Log each refresh in `exchange/ledger/2025-11.md` with date, scope, and actor.
- Gate merges touching gameplay tooling on corresponding doc alignment.
